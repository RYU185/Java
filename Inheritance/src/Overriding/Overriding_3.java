...
public class Overriding_3 {
    public static void main(String[] args) {
        ...
        BB value2 = new BB();
        value2.print1(); // BB클래스 print1 ( 오버라이딩이므로 )
        value2.print2(); // 매개변수가 없는 print2 이므로 AA클래스 print2
        value2.print2(3); // BB클래스 print2
        AA value3 = new BB();
        value3.print1(); // BB클래스 print1 ( 오버라이딩이므로 )
        value3.print2(); // 매개변수가 없는 print2 이므로 AA클래스 print2
    }
}
